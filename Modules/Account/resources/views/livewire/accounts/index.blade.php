<div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Quản lý user đăng nhập, nhân viên công ty và khách hàng cá nhân.</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Tài
                            khoản</th>
                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Loại
                        </th>
                    ...
                    @forelse ($accounts as $account)
                        ...
                        <tr wire:key="account-{{ $account->id }}" class="hover:bg-gray-50">
                            <td class="px-4 py-4">
                                ...
                                @else
                                    <input type="checkbox" value="{{ $account->id }}" wire:model.live="selectedIds"
                                        class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                @endif
                            </td>

                            <td class="px-4 py-4">
                                <div class="font-semibold text-gray-900">{{ $account->name ?: 'Chưa có tên' }}</div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-12 text-center">
                                ...
                                <div class="mt-1 text-sm text-gray-500">Hãy thêm tài khoản đầu tiên cho hệ thống.</div>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
