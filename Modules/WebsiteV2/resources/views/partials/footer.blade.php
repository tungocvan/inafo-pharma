{{--
    ...
    Variables: $footerSettings, $footerColumns, $socialLinks, $headerSettings
--}}

@php
    $brandName = $headerSettings['brand_name'] ?? 'WebsiteV2';
@endphp
    ...
    <div class="container mx-auto px-4 pt-16 pb-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
            <div class="lg:col-span-4 space-y-6">
                <a href="{{ route('website-v2.home') }}" class="flex items-center gap-2 group">
                    ...
                    <span class="text-2xl font-bold text-white tracking-tight">
                        {{ $brandName }}<span class="text-blue-500">.</span>
                    </span>
                </a>

                <p class="text-sm leading-relaxed text-gray-500">
                    {{ $footerSettings['description'] ?? 'Brand description has not been updated.' }}
                </p>
                ...
                <div class="space-y-3">
                    <div class="flex items-start gap-3">
                        ...
                        <span class="text-sm">{{ $footerSettings['address'] ?? 'Address has not been updated' }}</span>
                    </div>
            ...
            <div class="lg:col-span-3">
                <h3 class="text-white font-bold text-lg mb-6">Download App</h3>
                <p class="text-xs text-gray-500 mb-4">Shop more easily with the {{ $brandName }} app</p>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="text-xs text-gray-500 text-center md:text-left">
                <p>{{ $footerSettings['copyright'] ?? 'Copyright ' . $brandName . '. All rights reserved.' }}</p>
            ...
            <div class="flex items-center gap-4 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
                <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Visa_Inc._logo.svg" class="h-6 w-auto bg-white rounded p-1" alt="Visa">
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" class="h-6 w-auto bg-white rounded p-1" alt="Mastercard">
                <img src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" class="h-6 w-auto bg-white rounded p-1" alt="PayPal">
                <img src="https://webmedia.com.vn/images/2021/09/logo-da-thong-bao-bo-cong-thuong-mau-xanh.png" class="h-10 w-auto" alt="Registered with Ministry of Industry and Trade">
            </div>
        </div>
    </div>
</footer>
